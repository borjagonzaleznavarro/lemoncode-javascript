...
_dataBusinessJs.getCharacters().then((datos)=>{
    ...
    for (character of datosCharacters)root.append(_utilsJs.createCharacterRow(character));
    document.querySelectorAll(".character-row").forEach(function(element) {
        element.addEventListener("click", function() {
            ...
            characterDetails.append(_utilsJs.showCharacter(item));
        });
    });
}).catch((error)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}]},["66IEb","8lqZg"], "8lqZg", "parcelRequire2470")
