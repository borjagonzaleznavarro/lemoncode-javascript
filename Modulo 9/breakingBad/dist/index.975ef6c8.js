...
})({"66IEb":[function(require,module,exports) {
...
let characterID;
let characterName;
_dataBusinessJs.getCharacters().then((datos)=>{
    root.innerHTML = "";
    for (character of datos)root.append(_utilsJs.createCharacterRow(character));
    document.querySelectorAll(".character-row").forEach(function(element) {
        element.addEventListener("click", function() {
            ...
            _dataBusinessJs.getCharacterDetails(characterID).then((datos)=>{
                for (character of datos)characterDetails.append(_utilsJs.showCharacter(character));
...
function getQuotes(characterName) {
    _dataBusinessJs.getCharacterQuotes(characterName).then((quotes)=>{
        for (quote of quotes)characterDetails.append(_utilsJs.showQuotes(quote.quote));
    }).catch((error)=>{
        characterDetails.innerHTML = "Ha ocurrido un error intentando recoger los datos";
    });
}

},{"./styles.css":"lW6qc","./data-business.js":"iM7Bx","./utils.js":"en4he"}],"lW6qc":[function() {},{}],"iM7Bx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCharacters", ()=>getCharacters);
parcelHelpers.export(exports, "getCharacterDetails", ()=>getCharacterDetails);
parcelHelpers.export(exports, "getCharacterQuotes", ()=>getCharacterQuotes);
...
function getCharacterQuotes(character) {
    return fetch("https://www.breakingbadapi.com/api/quote?author=" + character + "").then((response)=>{
        return response.json();
    });
}
...
parcelHelpers.export(exports, "showQuotes", ()=>showQuotes);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}]},["66IEb","8lqZg"], "8lqZg", "parcelRequirea389")
