...
exports.onUpdateField = exports.onSubmitForm = exports.onSetValues = exports.onSetFormErrors = exports.onSetError = exports.onAddFile = exports.clearForm = void 0;
...
var clearForm = function clearForm(id) {
  ...
  var texareas = document.getElementById(id).getElementsByTagName("textarea");
  var formElements = [].concat(_toConsumableArray(inputs), _toConsumableArray(texareas));
...
exports.insertProperty = exports.getSaleTypeList = exports.getProvinceList = exports.getEquipmentsList = void 0;
...
var getEquipmentsList = function getEquipmentsList() {
  return _axios.default.get(equipmentsListUrl).then(function (response) {
    return response.data;
  });
};
exports.getEquipmentsList = getEquipmentsList;
var insertPropertyUrl = "".concat("http://localhost:3000/api", "/properties");
var insertProperty = function insertProperty(property) {
  return _axios.default.post("".concat(insertPropertyUrl), property).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
...
exports.formValidation = exports.featureValidation = void 0;
var _fonk = require("@lemoncode/fonk");
...
exports.formValidation = formValidation;
var featureValidation = (0, _fonk.createFormValidation)(validationFeature);
exports.featureValidation = featureValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-is-number-validator":"../node_modules/@lemoncode/fonk-is-number-validator/dist/@lemoncode/fonk-is-number-validator.esm.js","@lemoncode/fonk-array-required-validator":"../node_modules/@lemoncode/fonk-array-required-validator/dist/@lemoncode/fonk-array-required-validator.esm.js","@lemoncode/fonk-is-url-validator":"../node_modules/@lemoncode/fonk-is-url-validator/dist/@lemoncode/fonk-is-url-validator.esm.js"}],"pages/upload-property/upload-property.mapper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapUploadPropertyFromApiToVM = void 0;
var mapUploadPropertyFromApiToVM = function mapUploadPropertyFromApiToVM(uploadProperty) {
  return mapUpPropertyFromApiToViewModel(uploadProperty);
};
exports.mapUploadPropertyFromApiToVM = mapUploadPropertyFromApiToVM;
var mapUpPropertyFromApiToViewModel = function mapUpPropertyFromApiToViewModel(property) {
  return {
    id: property.id,
...
},{"qs":"../node_modules/qs/lib/index.js"}],"pages/upload-property/upload-property.js":[function(require,module,exports) {
"use strict";
...
Promise.all([(0, _uploadProperty.getSaleTypeList)(), (0, _uploadProperty.getProvinceList)(), (0, _uploadProperty.getEquipmentsList)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 3),
    salesTypeList = _ref2[0],
    provinceList = _ref2[1],
    equipmentList = _ref2[2];
  (0, _uploadProperty2.setCheckboxList)(salesTypeList, 'saleTypes');
  (0, _uploadProperty2.setOptionList)(provinceList, 'province');
  (0, _uploadProperty2.setCheckboxList)(equipmentList, 'equipments');
});
(0, _helpers.onUpdateField)('title', function (event) {
  var value = event.target.value;
  uploadProperty = _objectSpread(_objectSpread({}, uploadProperty), {}, {
    title: value
  });
  _uploadProperty3.formValidation.validateField('title', uploadProperty.title).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('notes', uploadProperty.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('email', uploadProperty.email).then(function (result) {
...
(0, _helpers.onUpdateField)('phone', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('phone', uploadProperty.phone).then(function (result) {
...
(0, _helpers.onUpdateField)('price', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('price', uploadProperty.price).then(function (result) {
...
(0, _helpers.onUpdateField)('saleTypes', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('saleTypes', uploadProperty.newSaleType).then(function (result) {
...
(0, _helpers.onUpdateField)('address', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('address', uploadProperty.address).then(function (result) {
...
(0, _helpers.onUpdateField)('city', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('city', uploadProperty.city).then(function (result) {
...
(0, _helpers.onUpdateField)('province', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('province', uploadProperty.provinceId).then(function (result) {
...
(0, _helpers.onUpdateField)('squareMeter', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('squareMeter', uploadProperty.squareMeter).then(function (result) {
...
(0, _helpers.onUpdateField)('rooms', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('rooms', uploadProperty.rooms).then(function (result) {
...
(0, _helpers.onUpdateField)('bathrooms', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('bathrooms', uploadProperty.bathrooms).then(function (result) {
...
(0, _helpers.onUpdateField)('locationUrl', function (event) {
  ...
  _uploadProperty3.formValidation.validateField('locationUrl', uploadProperty.locationUrl).then(function (result) {
    (0, _helpers.onSetError)('locationUrl', result);
  });
});
(0, _helpers.onUpdateField)('newFeature', function (event) {
  var value = event.target.value;
  uploadProperty = _objectSpread(_objectSpread({}, uploadProperty), {}, {
    newFeature: value
  });
  _uploadProperty3.formValidation.validateField('newFeature', uploadProperty.newFeature).then(function (result) {
    (0, _helpers.onSetError)('newFeature', result);
  });
});
(0, _helpers.onSubmitForm)('insert-feature-button', function () {
  console.log('validando feature');
  _uploadProperty3.featureValidation.validateField('newFeature', uploadProperty.newFeature).then(function (result) {
    (0, _helpers.onSetError)('newFeature', result);
    if (result.succeeded) {
      (0, _uploadProperty2.onAddFeature)(uploadProperty.newFeature);
      uploadProperty.mainFeatures.push(uploadProperty.newFeature);
      _uploadProperty3.formValidation.validateField('mainFeatures', uploadProperty.mainFeatures).then(function (result) {
        (0, _helpers.onSetError)('mainFeatures', result);
        uploadProperty.mainFeatures.map(function (feature) {
          (0, _helpers.onSubmitForm)((0, _uploadProperty2.formatDeleteFeatureButtonId)(feature), function () {
            (0, _uploadProperty2.onRemoveFeature)(feature);
            var index = uploadProperty.mainFeatures.indexOf(feature);
...
(0, _helpers.onUpdateField)('equipments', function (event) {
  ...
  //     });
  _uploadProperty3.formValidation.validateField('equipments', uploadProperty.newEquipment).then(function (result) {
...
(0, _helpers.onUpdateField)('images', function (event) {
  ...
  (0, _helpers.onAddFile)('add-image', function (value) {
    (0, _uploadProperty2.onAddImage)(value);
    uploadProperty.images.push(value);
  });
  _uploadProperty3.formValidation.validateField('images', uploadProperty.images).then(function (result) {
    (0, _helpers.onSetError)('images', result);
  });
});
var onSave = function onSave() {
  return (0, _uploadProperty.insertProperty)(uploadProperty);
};
(0, _helpers.onSubmitForm)('save-button', function () {
  ...
  uploadProperty = (0, _uploadProperty4.mapUploadPropertyFromApiToVM)(uploadProperty);
  _uploadProperty3.formValidation.validateForm(uploadProperty).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);
    if (result.succeeded) {
      onSave().then(function () {
        alert('Nueva vivienda guardada correctamente');
