...
exports.insertMessage = exports.getProperty = exports.getEquipmentsList = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api", "/properties");
var getProperty = function getProperty(propertyId) {
  return _axios.default.get("".concat(url, "?id=").concat(propertyId)).then(function (response) {
...
var insertMessage = function insertMessage(message) {
  return _axios.default.post("".concat(contactUrl), message).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/property-detail/property-detail.mappers.js":[function(require,module,exports) {
"use strict";
...
var mapPropertyListFromApiToVm = function mapPropertyListFromApiToVm(property) {
...
},{"./property-detail.api":"pages/property-detail/property-detail.api.js"}],"pages/property-detail/property-detail.helpers.js":[function(require,module,exports) {
"use strict";
...
var _propertyDetail2 = require("./property-detail.mappers");
...
var loadProperty = function loadProperty(apiProperty, equipmentsList) {
  var equipmentIds = apiProperty[0].equipmentIds;
  var equipmentsNames = equipmentIds.map(function (equipment) {
    return equipmentsList.find(function (apiEquipment) {
      return apiEquipment.id === equipment.toString();
    }).name;
  });
  apiProperty[0].equipmentNames = equipmentsNames;
  var property = (0, _propertyDetail2.mapPropertyListFromApiToVm)(apiProperty);
  (0, _propertyDetail3.setPropertyValues)(property[0]);
};

// Comprobamos si existe el parámetro en la url
if (getId) {
  (0, _propertyDetail.getProperty)(params.id).then(function (apiProperty) {
    // Comprobamos que haya resultados
    Promise.all([(0, _propertyDetail.getProperty)(params.id), (0, _propertyDetail.getEquipmentsList)()]).then(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
        apiProperty = _ref2[0],
        equipmentsList = _ref2[1];
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  contactForm = _objectSpread(_objectSpread({}, contactForm), {}, {
    email: value
  });
  _propertyDetail4.formValidation.validateField('email', contactForm.email).then(function (result) {
...
(0, _helpers.onUpdateField)('message', function (event) {
  ...
  _propertyDetail4.formValidation.validateField('message', contactForm.message).then(function (result) {
    (0, _helpers.onSetError)('message', result);
  });
});
(0, _helpers.onSubmitForm)('contact-button', function () {
  _propertyDetail4.formValidation.validateForm(contactForm).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);
    if (result.succeeded) {
      (0, _propertyDetail.insertMessage)(contactForm);
      (0, _helpers.clearForm)('contact-form');
      alert('El mensaje ha sido enviado');
    }
  });
});
},{"./property-detail.api":"pages/property-detail/property-detail.api.js","../../core/router":"core/router/index.js","./property-detail.mappers":"pages/property-detail/property-detail.mappers.js","./property-detail.helpers":"pages/property-detail/property-detail.helpers.js","../../common/helpers":"common/helpers/index.js","./property-detail.validations":"pages/property-detail/property-detail.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
