...
(0, _helpers.onUpdateField)('type', function (event) {
  ...
  _account.formValidation.validateField('type', account.alias).then(function (result) {
...
(0, _helpers.onUpdateField)('alias', function (event) {
  ...
  _account.formValidation.validateField('alias', account.type).then(function (result) {
