...
},{}],"../node_modules/@lemoncode/fonk-range-number-validator/dist/@lemoncode/fonk-range-number-validator.esm.js":[function(require,module,exports) {
"use strict";
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"../node_modules/@lemoncode/fonk-min-number-validator/dist/@lemoncode/fonk-min-number-validator.esm.js":[function(require,module,exports) {
"use strict";
...
var validationSchema = {
  field: {
    iban: [_fonk.Validators.required, _fonkIbanValidator.iban.validator],
    name: [_fonk.Validators.required],
    amount: [_fonk.Validators.required, _fonkIsNumberValidator.isNumber],
...
},{"axios":"../node_modules/axios/index.js"}],"pages/transfer/transfer.api.js":[function(require,module,exports) {
"use strict";
...
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api", "/transfer");
var insertTransfer = function insertTransfer(transfer) {
  return _axios.default.post(url, transfer).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
...
var _transfer = require("./transfer.validations");
...
(0, _helpers.onUpdateField)('select-account', function (event) {
  ...
  _transfer.formValidation.validateField('select-account', transfer.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('iban', function (event) {
  ...
  _transfer.formValidation.validateField('iban', transfer.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('name', function (event) {
  ...
  _transfer.formValidation.validateField('name', transfer.name).then(function (result) {
...
(0, _helpers.onUpdateField)('amount', function (event) {
  ...
  _transfer.formValidation.validateField('amount', transfer.amount).then(function (result) {
...
(0, _helpers.onUpdateField)('concept', function (event) {
  ...
  _transfer.formValidation.validateField('concept', transfer.concept).then(function (result) {
...
(0, _helpers.onUpdateField)('day', function (event) {
  ...
  _transfer.formValidation.validateField('day', transfer.day).then(function (result) {
...
(0, _helpers.onUpdateField)('month', function (event) {
  ...
  _transfer.formValidation.validateField('month', transfer.month).then(function (result) {
...
(0, _helpers.onUpdateField)('year', function (event) {
  ...
  _transfer.formValidation.validateField('year', transfer.year).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _transfer.formValidation.validateField('email', transfer.email).then(function (result) {
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  ...
  _transfer.formValidation.validateForm(transfer).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);
    if (result.succeeded) {
      onTransfer().then(function (apiTransfer) {
        _router.history.back();
      });
    }
  });
});
},{"../../common/helpers":"common/helpers/index.js","./transfer.validations":"pages/transfer/transfer.validations.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../../core/router":"core/router/index.js","../account-list/account-list.api":"pages/account-list/account-list.api.js","./transfer.api":"pages/transfer/transfer.api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
